...
export const TRANSLATION_MODEL_DOWNLOAD_STARTED_EVENT = "translation-model://download-started";
export const TRANSLATION_MODEL_DOWNLOAD_PROGRESS_EVENT = "translation-model://download-progress";
export const TRANSLATION_MODEL_DOWNLOAD_COMPLETED_EVENT = "translation-model://download-completed";
export const TRANSLATION_MODEL_DOWNLOAD_FAILED_EVENT = "translation-model://download-failed";
